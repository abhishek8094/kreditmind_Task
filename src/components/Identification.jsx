...
const UploadDocument = () => {
  ...
  // Handle file change for PAN Card
  const handlePanCardChange = (e) => {
    setPanCardFile(e.target.files[0]);
  };

  // Handle file change for Aadhar Card
  ...
  return (
    <div className="flex gap-6 mt-4">
      ...
      <div className="border rounded-lg p-4  w-80 m-4">
        ...
        <p className="text-gray-500 mb-4 text-sm">Browse or drag and drop file here</p>
      ...
      <div className="border border-gray-200 rounded-lg p-4 w-80 m-4">
        <div className="text-green-500 mb-4 w-10 p-2 h-10 rounded-full bg-[#f2f4f7]">
        <GrFormUpload className="text-2xl" />
        </div>
