    ...
    <>
      <div className="flex gap-10 mt-8">
        {documentStep.map((document, id) => (
          <div key={id}>
            <div
              className={`border border-gray-300 p-2 text-xs text-[#7d7d7d] font-semibold rounded-full ${
      ...
      <div className="border-solid border-[1.5px] relative top-10 rounded-lg">
        <div className="p-4">
          ...
          <div className="flex justify-between items-center mt-6">
            <button
              onClick={handleBack}
              className={`border border-gray-200 p-3 w-[90px] flex justify-center items-center rounded-lg cursor-pointer transition-opacity ${
                currentStep === 1
